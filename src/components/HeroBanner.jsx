            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>rishigupta88616@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Rishi Gupta</span>
                    </div>
                    <div className="max-w-[510px]">
                    I Develop and maintain websites and React applications
                    utilizing Material UI, Ant Design, and Chakra UI
                    For efficient and visually appealing component design
                    </div>
                </motion.div>
                {/* INTRO END */}
