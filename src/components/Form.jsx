...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_d3i5ynd", // Service ID
            "template_6vz5nxi", // Template ID
            userInput,
            "s0ZbTMLGw5nlLRtDE" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
            ...
            >
                ...
                <div className="flex flex-col gap-2">
                    <label
                        ...
                        className="text-[16px] text-black uppercase"
                    >
                        Please tell a bit about the Role,CTC,location and the Joining date!
                        <sup>*</sup>
                    </label>
                    <textarea
                        name="message"
