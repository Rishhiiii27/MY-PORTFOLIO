...
import sk1 from "../assets/nodejs.png";
import sk2 from "../assets/mongodb.png";
import sk3 from "../assets/express.png";
import sk4 from "../assets/tailwind.png";
import sk5 from "../assets/scss.png";
import sk6 from "../assets/C++.png";
            ...
            <Wrapper>
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="VENERA TECHNOLOGIES "
                            desc="Interned as a MERN Stack Developer, adeptly deploying,developing and debugging web applications using React.js,
                            Node.js, Express, and MongoDB
                            Demonstrated skills in code optimization, utilizing platforms like Retlify for deployment and implementing debug- ging
                            techniques for efficient issue resolution."
                            data={[
                                "SDE INTERN",
                                // "Wireframe",
                                // "User Experience",
                        ...
                        <Service
                            num="2"
                            title="IBM"
                            desc="Engaged in an enriching internship at IBM, actively participating in the IBM Skill-Build program Acquired
                            comprehensive proficiency in JavaScript and the React framework through guidance from esteemed mentors,
                            adeptly applying these skills to solve real-world challenges and drive impactful solutions"
                            data={[
                                "STUDENT INTERN",
                                // "Wireframe",
                                // "User Experience",
