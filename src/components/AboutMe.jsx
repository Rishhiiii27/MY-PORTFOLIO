        ...
        >
            ...
            <Wrapper>
                ...
                <Div className="text-[40px] md:text-[90px] 2xl:text-[120px] leading-[52px] md:leading-[95px] 2xl:leading-[123px] font-oswald uppercase mb-[25px] md:mb-[40px] 2xl:mb-[60px] flex flex-col relative">
                    <span>A Frontend/Fullstack Developer</span>
                ...
                I'm Rishi, a passionate and results-driven recent graduate 
                with expertise in both frontend and full-stack development
                </Div>
                {/* PARAGRAPH END */}

                {/* PARAGRAPH START */}
                <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
                My skill set includes the dynamic trio of ReactJS, MongoDB, and Node.js, 
                complemented by proficiency in Express.js for robust server-side development.
                For visually stunning and user-friendly interfaces i mostly
                use  Material UI and Ant Design for impeccable styling
                </Div>
                {/* PARAGRAPH END */}

                {/* PARAGRAPH START */}
                <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] relative">
                With a solid foundation and an insatiable appetite for continuous learning, 
                I am actively seeking the perfect opportunity to demonstrate and further develop my skills.
                </Div>
                {/* PARAGRAPH END */}
            </Wrapper>
        </div>
